   ...
   <div class="about row small-up-1 medium-up-2 large-up-4" id="contacto" data-magellan-target="contacto">
        ...
        <h5>Contacto:</h5>
            <ul>
                ...
                <li><img src="assets/iconos/person-icon.png" class="icono-footer"/> <a href="#" target="_blank">Dr. Lorenzo Díaz Cruz</a></li>
                <li><img src="assets/iconos/phone-icon.png" class="icono-footer"/> <a href="#" target="_blank">+52(222)2295500 </a></li>
                <li><img src="assets/iconos/email-icon.png" class="icono-footer"/> <a href="#" target="_blank"> CIFFU.BUAP@gmail.com</a></li>
